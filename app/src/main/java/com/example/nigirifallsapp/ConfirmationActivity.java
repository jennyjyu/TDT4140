...
public class ConfirmationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text;
        if(min < 10){
            text = "Your order has been registered and is sent to the restaurant. It will be ready for pick-up at " + hourOfDay + ":0" + min;
        } else {
            text = "Your order has been registered and is sent to the restaurant. It will be ready for pick-up at " + hourOfDay + ":" + min;
        }
        text += "\n\n\nYour pick-up reference is" + getOrderID() +"\n\n\n\n";
